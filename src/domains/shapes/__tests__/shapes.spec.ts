        ...
        expect(result).toStrictEqual(
            expect.arrayContaining(<ShapeDTO[]>[
                expect.objectContaining(<ShapeDTO>{
                    ...
                    path:(expect.any(String) || expect.arrayContaining(expect.arrayContaining([expect.any(String), expect.any(Number)]))) || expect.anything(),
                    ...
                    stroke:expect.any(expect.any(String),) || expect(null),
                    strokeDashArray: expect.arrayContaining([expect.any(String)]) || expect(null),
